...
Only output the list of objects, with nothing else. Should respond within the category and products that have list above and shouldn't respond anything beyond this.  
"""
...
def read_string_to_list(input_string):
    ...
    try:
        # Remove triple backticks and newlines
